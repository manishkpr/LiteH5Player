...
class UIBtnControlBar extends React.Component {
  ...
  // Custom Methods
  setUIPlayerCompons(uiPlayer) {
    this.uiPlayer_ = uiPlayer;
  }
...
window.onload = function() {
  ...
  reactUIPlayer = ReactDOM.render(
    <UIPlayer/>,
    document.getElementById('player-container'));

  reactUIBtnControlBar = ReactDOM.render(
    <UIBtnControlBar />,
    document.getElementById('idBtnController')
  );
  reactUIBtnControlBar.setUIPlayerCompons(reactUIPlayer);
