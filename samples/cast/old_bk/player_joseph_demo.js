...
//////////////////////////////////////////////////////////////////////
// Begin joseph test here for liteh5player
var player = null;
...
function initContent() {
  ...
  vContents = [];
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_begin_0_1.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_1_0.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_1_1.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_2_0.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_2_1.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_3_0.mp4');
  vContents.push('http://10.2.72.157/tasklink/65071/mac_chrome/video_data_0_3_1.mp4');
...
function initDRM_WV() {
  ...
  // aContents.push('http://10.2.72.157/tasklink/65421/content_wv_shaka/a-eng-0128k-aac.mp4');

  videoCodec = 'video/mp4; codecs="avc1.42c01e"';
  vContents.push('http://10.2.72.157/tasklink/65421/content_wv_shaka/v-0144p-0100k-libx264.mp4');
...
function initDRM_PR() {
  switch(1)
  {
    case 0:
    {
      ...
      //vContents.push('http://10.2.72.157/tasklink/65421/content_pr/dash.mp4');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-0.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-49152.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-98304.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-147456.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-196608.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-245760.dash');
      vContents.push('https://10.2.72.157/tasklink/65421/content_pr/dash/tears-of-steel-dash-playready-video_eng=405000-294912.dash');
    ...
    case 1:
    {
      ...
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/Header.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/0.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/1.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/2.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/3.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/4.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/5.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/6.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/7.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/8.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/9.m4s');
      vContents.push('http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/video5/10.m4s');

      laURL = 'http://essdrmproducts-eu.insidesecure.com/test-portal/device/portal?PlayRight=1';
      drmType = 'com.microsoft.playready';
    } break;
    default:
    break;
...
// End joseph test here
/////////////////////////////////////////////////////////////////////////////////////////////


/////////////////////////////////////////////////////////////////////////////////////////////
// Begin joseph add for shaka simpleset player
//var manifestUri = 'http://storage.googleapis.com/shaka-demo-assets/angel-one/dash.mpd';
//var manifestUri = 'http://rdmedia.bbc.co.uk/dash/ondemand/testcard/1/client_manifest-events.mpd';

// widevine
// var manifestUri = "//demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-dash-widevine.ism/.mpd";
// var licenseServers = {'com.widevine.alpha': '//widevine-proxy.appspot.com/proxy'};

// playready
// var manifestUri = '//10.2.72.157/tasklink/65421/content_pr/test.mpd';
// var licenseServers = {
//   'com.microsoft.playready':
//   '//test.playready.microsoft.com/service/rightsmanager.asmx?PlayRight=1&UseSimpleNonPersistentLicense=1'  // gjslint: disable=110
// };

// playready02
var manifestUri = '//10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/test.mpd';
var licenseServers = {
   'com.microsoft.playready':
   '//essdrmproducts-eu.insidesecure.com/test-portal/device/portal?PlayRight=1'  // gjslint: disable=110
};
...
function initPlayer() {
  ...
  config.drm.servers = licenseServers;
...
sampleplayer.CastPlayer = function(element) {
  ...
  //
  this.onPlayOrig_ =
      this.mediaManager_.onPlay.bind(this.mediaManager_);
...
sampleplayer.CastPlayer.prototype.load = function(info) {
  console.log('begin of load function');
...
sampleplayer.CastPlayer.prototype.loadVideo_ = function(info) {
  ...
  ///////////////////////////////////////////////////////////////////////////////
  // Begin - joseph modifiy

  // case
  // url = 'http://dash.akamaized.net/dash264/TestCases/6b/microsoft/CENC_HD_Time/CENC_HD_time_MPD.mpd';
  // var drmType = 'playready';

  // case - ok
  // url = 'http://dash.akamaized.net/dash264/TestCases/6b/microsoft/CENC_SD_Time/CENC_SD_time_MPD.mpd';
  // var drmType = 'playready';

  // case - failed
  //url = "http://10.2.72.157/2/drm/content-tc/DASH/Encrypted/Envivio-0509/test.mpd";
  // playready
  ...
  var licenseUrl = 'http://playready-testserver.azurewebsites.net/rightsmanager.asmx?PlayRight=1&UseSimpleNonPersistentLicense=1';
  var drmType = 'playready';

  // case - ok
  // url = 'https://demo.unified-streaming.com/video/tears-of-steel/tears-of-steel-dash-playready.ism/.mpd';
  // var licenseUrl = 'https://test.playready.microsoft.com/service/rightsmanager.asmx?PlayRight=1&UseSimpleNonPersistentLicense=1';
  // var drmType = 'playready';
  ...
  if (false) {
    ...
    if (!this.preloadPlayer_ || (this.preloadPlayer_.getHost &&
      ...
      // default
      this.log_('Begin MPL test');
      this.player_ = new cast.player.api.Player(host);
      this.player_.load(protocolFunc(host));
      this.log_('End MPL test');

      // my test for voPlayer
      // console.log('begin using voPlayer');
      // var player = voPlayer.Player().create();
      // player.init(true);
      // player.setView(this.mediaElement_);
      // //player.setDRMVerificationInfo(protInfoList);
      // player.setDRMVerificationInfo(protInfoListTmp);
      // player.open(url);
      // console.log('end using voPlayer');

      // //my test for liteh5player
      // console.log('begin liteh5player');
      // var media = this.mediaElement_;
      // player = h5player.MediaPlayer().create();
      // player.init(media);
      // player.on(h5player.Events.MSE_OPENED, onMSEOpened, null);
      // player.open(initH5Content());
      // console.log('end liteh5player');

      // my test for shaka player
      // console.log('Begin initApp');
      // initApp();
...
sampleplayer.CastPlayer.prototype.onPlay_ = function(event) {
  console.log('--my test here, onPlay_--');
