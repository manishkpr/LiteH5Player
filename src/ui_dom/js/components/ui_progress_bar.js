...
class UIProgressBar extends Component {
  ...
  toDom() {
    ...
    let vLoadProgress = document.createElement('div');
    vLoadProgress.setAttribute('class', 'vop-load-progress');

    let vHoverProgress = document.createElement('div');
    vHoverProgress.setAttribute('class', 'vop-hover-progress');

    let vPlayProgress = document.createElement('div');
    vPlayProgress.setAttribute('class', 'vop-play-progress');

    vProgressList.appendChild(vLoadProgress);
    vProgressList.appendChild(vHoverProgress);
    vProgressList.appendChild(vPlayProgress);
